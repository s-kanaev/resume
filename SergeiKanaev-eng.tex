...
Was involved in application development. The application used multigrids to prepare cartographic data for route-finding algorithms. Regarding this, there is a certificate (No 46694) of registration of copyright in the product:
\begin{itemize}
