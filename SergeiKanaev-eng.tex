...
\section{Experience}
\cventry{10.2016 --- till now}{Engineer}{Brogaming Studio / Starlab Studio}{Samara}{\newline{}Mobile game server development}{During this work I involved in: %
\begin{itemize}
...
\end{itemize}%
During this work I've had experience with \texttt{libpq}, \texttt{libsqlite3}, \texttt{libev}, \texttt{libconfig} and \texttt{jsoncpp} libraries.}
