...
\section{Experience}
\cventry{10.2016 --- till now}{Engineer}{Brogaming Studio}{Samara}{\newline{}Mobile game server development}{During this work I developed: %
\begin{itemize}
\item matchmaking algorithm;
\item test client for testing specific server functions;
\item database scheme for specific server functions.
\end{itemize}%
During this work I've had experience with \texttt{libpq}, \texttt{libev} libraries.}
